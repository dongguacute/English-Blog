...
export const siteConfig: SiteConfig = {
	title: "CherryEnglishBlog",
	subtitle: "English Blog",
	...
	banner: {
		enable: true,
		src: "assets/images/hero.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/dongguacute/English-Blog", // Internal links should not include the base path, as it is automatically added
